 ...
 * @preferred
 */
import { Async, Enhanced, FlatGen, Genable, GeneratorOps, IndexedFn, IndexedPredicate, Reducer, ReturnValue, SyncType } from "./types";
/**
 ...
 * methods.
 */
export declare abstract class Enhancements<T, TReturn, TNext, S extends SyncType> {
    abstract _impl: GeneratorOps<S>;
    returning?: any;
    abstract next(...arg: [] | [arg: TNext]): S extends Async ? Promise<IteratorResult<T, TReturn>> : IteratorResult<T, TReturn>;
    abstract return(value: TReturn): S extends Async ? Promise<IteratorReturnResult<TReturn>> : IteratorReturnResult<TReturn>;
    abstract throw(e: any): S extends Async ? Promise<IteratorReturnResult<TReturn>> : IteratorReturnResult<TReturn>;
    abstract [Symbol.iterator]: S extends Async ? undefined : () => this & IterableIterator<T>;
    abstract [Symbol.asyncIterator]: S extends Async ? () => this & AsyncIterableIterator<T> : undefined;
    [Symbol.toStringTag]: S extends Async ? 'EnhancedAsyncGenerator' : 'EnhancedGenerator';
    /**
     ...
     */
    flat<D extends number>(depth?: D): Enhanced<S, FlatGen<T, D>, TReturn, TNext>;
    /**
     ...
     * @param depth
     */
    flatMap<D extends number = 1>(f: IndexedFn<T, FlatGen<T, D>, S>, depth?: D): Enhanced<S, FlatGen<T, D>, TReturn, TNext>;
    /**
     ...
     * @param gens
     */
    zip<G extends (Genable<T, S, TReturn, TNext>)[], T, TReturn, TNext>(...gens: G): Enhanced<Array<T>, S, TReturn, TNext>;
    /**
